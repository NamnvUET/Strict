...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 20, 2017 lúc 05:34 PM
...
(13, 'STRICT BANNER 1', 'STRICT ifpofopdfbigjvcajs io vbgfgkldnvci STRICT', '2017-06-20 09:53:44', '2017-06-20 09:53:44', '.././uploads/banners/banner.jpg');
...
(6, 'Nguyễn Đình Mạnh', 'vcl@gmail.com', 'fefefefefefefe', 1, '2017-06-19 06:58:00', '2017-06-19 06:58:00');
...
('facebook', 'http://facebook.com/gg', '2017-06-19 07:10:52', '2017-06-20 10:18:38'),
...
INSERT INTO `subpages` (`subpage_id`, `title`, `icon`, `content`, `created_at`, `updated_at`) VALUES
(2, 'Optimized for all devices', '.././uploads/subpage_icon/icon3.jpg', 'STRICT has been designed to be fully responsive on all devices', '2017-06-19 08:58:17', '2017-06-19 08:58:17'),
(3, 'Cefdi 2', '.././uploads/subpage_icon/icon2.jpg', 'STRICT has been designed to be fully responsive on all devices', '2017-06-19 08:59:55', '2017-06-20 10:20:51'),
(4, 'Icon 4', '.././uploads/subpage_icon/icon1.jpg', 'Gờ gờ', '2017-06-19 09:14:52', '2017-06-19 09:14:52'),
(5, 'GGWP', '.././uploads/subpage_icon/icon2.jpg', 'gờ gờ 2', '2017-06-19 09:15:10', '2017-06-19 09:15:10'),
(6, 'giưeifwejifeqf', '.././uploads/subpage_icon/icon3.jpg', 'qGREIOWFOEGIGEEJGWJ', '2017-06-19 09:15:53', '2017-06-19 09:15:53');
...
--
ALTER TABLE `banners`
  MODIFY `banner_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `showcases`
  MODIFY `showcase_id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT cho bảng `subpages`
--
ALTER TABLE `subpages`
  MODIFY `subpage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
