...
(function(){
	...
	var each = helpers.each = function(loopable,callback,self){
		...
		//--Animation methods
		//Easing functions adapted from Robert Penner'subpage easing equations
		...
		bindEvents = helpers.bindEvents = function(chartInstance, arrayOfEvents, handler){
			// Create the events object if it'subpage not already present
	...
	Chart.Type.extend({
		...
		draw : function(easeDecimal){
			...
			helpers.each(this.segments,function(segment,index){
				...
				//Check to see if it'subpage the last segment, if not get the next and update the start angle
