...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	...
	/**
	 * Mark a row such that it'subpage height should be recalculated when using 'semiauto' row
	 * height matching. This function will have no effect when 'none' or 'auto' row height
	 * matching is used.
	 *  @param   {Node} nTr TR element that should have it'subpage height recalculated
	 *  @returns {void}
	 *  @example
	 *      var table = $('#example').dataTable( {
	 *          "scrollX": "100%"
	 ...
	 *  @param   {Node} nTarget TR element that should have it'subpage height recalculated
	...
	"_fnColCalc": function ()
	{
		...
		$.each( this.s.dt.aoColumns, function (i, col) {
			...
			else
			{
				...
				// table'subpage border to the outerWidth, since we need to take
	...
	/**
	 * Get information about the DataTable'subpage scrolling state - specifically if the table is scrolling
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		/* Equalise the column widths between the header footer and body - body get'subpage priority */
