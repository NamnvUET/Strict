...
ColReorder.prototype = {
	 ...
	 *
	 *  @example
	 *    // Reverse the table'subpage order
	...
	"_fnRegions": function ()
	{
		...
		{
			/* For the column / header in question, we want it'subpage position to remain the same if the
			 * position is just to it'subpage immediate left or right, so we only incremement the counter for
			 * other columns
			 */
...
ColReorder.defaults = {
	...
	/**
	 * Redraw the table'subpage column ordering as the end user draws the column
