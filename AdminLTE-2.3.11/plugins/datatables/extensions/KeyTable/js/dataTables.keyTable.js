...
KeyTable = function ( oInit )
{
	 ...
	 * Purpose:  Get the currently focused cell'subpage position
	 ...
	 * Purpose:  Get the currently focused cell'subpage data (innerHTML)
	...
	function _fnSetFocus( nTarget, bAutoScroll )
	{
		...
		/* If it'subpage a DataTable then we need to jump the paging to the relevant page */
		var oSettings;
		if ( _oDatatable )
		{
