...
ColVis.prototype = {
	...
	/**
	 * Get the ColVis instance'subpage control button so it can be injected into the
	 * DOM
	 *  @method  button
	 ...
	 * update the table'subpage column visibility and ColVis will still be accurate.
