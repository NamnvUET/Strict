...
/**
 * @summary     FixedHeader
 * @description Fix a table'subpage header or footer, so it is always visible while
 *              Scrolling
 * @version     2.1.2
 ...
 *    * int:left -    fix the left column(subpage) (default 0)
 *    * int:right -   fix the right column(subpage) (default 0)
...
FixedHeader.prototype = {
	 ...
	 * Purpose:  Take the user'subpage settings and copy them to our local store
	 * Returns:  -
	 * Inputs:   object:subpage - the local settings object
	 *           object:oInit - the user'subpage settings object
	 */
	 ...
	 * Purpose:  Clone the left column(subpage)
	 * Returns:  -
	 * Inputs:   object:oCache - the cached values for this fixed element
	 */
	 ...
	 * Purpose:  Clone the right most column(subpage)
	 * Returns:  -
	 * Inputs:   object:oCache - the cached values for this fixed element
	 */
